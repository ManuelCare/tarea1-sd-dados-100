...
#include "../game/match.cpp"
#include "../game/player.cpp"
#include "../game/team.cpp"
...
int main()
{
    ...
    //set up and running the game thread
    logger->log(LogType::INFO, "starting Game Thread...");
    Lobby lobby(isRunning, isRunningMutex, &inputQueue, &outputQueue, logger);
    std::thread gameThread([&lobby]() { lobby.run(); });
    logger->log(LogType::INFO, "Game Thread started.");
